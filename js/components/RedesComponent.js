Vue.component( 'redes-component' , {
    ...
    template: /*html*/`
    <div>
        <marquee class="lyricsWithBorder redes-component-marquee monserratBold">
            La velocidad y la capacidad de respuesta en los negocios están en constante crecimiento y son un punto competitivo
