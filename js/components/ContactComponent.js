    ...
    template: /*html*/ `
        <div>
            <div class="container monserratLight ">
                <div class="row contact-component-title">
                    <div class="col p-0">
            ...
            <div class="container monserratLight">
                <div class="row ">
                    <div class="col mt-2 d-none d-xs-block d-sm-block">
                        ...
                        <div class="w-100">
                            <h5 class="textPrimary monserratSemiBold mt-4"> Dirección </h5>
                            <p> General del Canto 426, Providencia, Santiago, Chile. </p>
                        </div>
                        <div class="w-100">
                            <h5 class="textPrimary monserratSemiBold mt-4"> Teléfono </h5>
                            <p> +56 23274 6200 </p>
                        </div> 
                        <div class="w-100">
                            <h5 class="textPrimary monserratSemiBold mt-4"> Email </h5>
                            <p> info@comseg.cl </p>
                        </div> 
                    </div> 
                    <div class="col ">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" ref="name" v-model="name" id="name" placeholder="Carlos Luis...">
                        </div>
                        <div class="form-group">
                            <label for="email" class="monserratBlack">Correo  Electrónico * </label>
                            <input type="text" class="form-control" ref="email" v-model="email" id="email" placeholder="carlos@ejemplo.com">
                        </div>
                        <div class="form-group ">
                            <label for="asunto" class="monserratBlack">Asunto *</label>
                            <input type="text" class="form-control" ref="asunto" v-model="asunto" id="asunto" placeholder="Comercial...">
                        </div>
                        <div class="form-group">
                            <label for="mensaje" class="monserratBlack">Mensaje * </label>
                            <textarea class="form-control" ref="mensaje" v-model="mensaje" id="mensaje" rows="3"></textarea>   
                        </div>
                        <button class="btn btn-primary btnBlack monserratBlack mt-2 mb-3"> enviar </button>
                        <small class="textPrimary ml-3 monserratBlack contact-component-field mt-2 mb-3"> *Campo obligatorio </small>
                    </div>    
                </div>
